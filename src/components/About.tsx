        ...
        <div className="space-y-16">
          ...
          <div className="grid gap-4 md:grid-cols-3 max-w-6xl mx-auto">
            {techStack.map((group, index) => (
              ...
              >
                <CardHeader>
                  <h4 className="text-xl font-semibold text-center">{group.title}</h4>
                </CardHeader>
                <CardContent>
          ...
          <div className="max-w-3xl mx-auto relative">
            ...
            {experiences.map((experience, index) => (
              ...
              >
                ...
                {/* Content */}
                <div className={`md:${index % 2 === 0 ? 'text-right' : 'text-left'} ${index % 2 === 0 ? 'md:pr-12' : 'md:order-2 md:pl-12'}`}>
                  <h4 className={`text-xl font-semibold ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>{experience.title}</h4>
                  <div className={`flex items-center gap-2 text-muted-foreground mt-1 mb-2 ${index % 2 === 0 ? 'justify-end' : ''}`}>
                    <Building2 className="h-4 w-4" />
                    <span>{experience.company}</span>
                  </div>
                  <div className={`flex items-center gap-2 text-muted-foreground mb-3 ${index % 2 === 0 ? 'justify-end' : ''}`}>
                    <Calendar className="h-4 w-4" />
                    <span>{experience.period}</span>
                  </div>
                </div>

                <div className={index % 2 === 0 ? 'md:pl-12 md:order-2' : 'md:pr-12 md:text-left'}>
                  <Card>
